...
public class Server2 {
    ...
    private static final int PORT2 = 5001; // Server1'nin portu
    ...
    private static void sunucuBaslat() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println("Server2 baglaniyor! Port: " + PORT);
            ...
            System.err.println("Server2, baglanirken hata olustu: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private static void digerSunucularaBaglan() {
        sunucuyaBaglan(HOST, PORT2); // server2 --> server1
    ...
    private static void sunucuyaBaglan(String host, int port){
        new Thread(() -> {
            try {
                ...
                System.out.println("Server2 ve Server" + (port - 5000) + " baglantisi kuruldu.");
